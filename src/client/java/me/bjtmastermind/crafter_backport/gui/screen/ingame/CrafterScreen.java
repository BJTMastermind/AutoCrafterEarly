...
//
package me.bjtmastermind.crafter_backport.gui.screen.ingame;
...
import me.bjtmastermind.crafter_backport.networking.ModMessages;
...
public class CrafterScreen extends HandledScreen<CrafterScreenHandler> {
    private static final Identifier DISABLED_SLOT_TEXTURE = new Identifier(CrafterBackport.MOD_ID, "textures/gui/sprites/container/crafter/disabled_slot.png");
    private static final Identifier POWERED_REDSTONE_TEXTURE = new Identifier(CrafterBackport.MOD_ID, "textures/gui/sprites/container/crafter/powered_redstone.png");
    private static final Identifier UNPOWERED_REDSTONE_TEXTURE = new Identifier(CrafterBackport.MOD_ID, "textures/gui/sprites/container/crafter/unpowered_redstone.png");
    private static final Identifier TEXTURE = new Identifier(CrafterBackport.MOD_ID, "textures/gui/container/crafter.png");
