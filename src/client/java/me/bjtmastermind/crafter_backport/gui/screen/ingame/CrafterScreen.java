...
public class CrafterScreen extends HandledScreen<CrafterScreenHandler> {
    private static final Identifier DISABLED_SLOT_TEXTURE = new Identifier(CrafterBackport.MOD_ID, "textures/gui/container/crafter/disabled_slot.png");
    private static final Identifier POWERED_REDSTONE_TEXTURE = new Identifier(CrafterBackport.MOD_ID, "textures/gui/container/crafter/powered_redstone.png");
    private static final Identifier UNPOWERED_REDSTONE_TEXTURE = new Identifier(CrafterBackport.MOD_ID, "textures/gui/container/crafter/unpowered_redstone.png");
